  ...
  return (
    <div className={cn(
      ...
      isCurrentPlan 
        ...
        : "border-blue-500 bg-gradient-to-r from-blue-500/10 via-indigo-500/10 to-blue-500/10"
    )}>
      <div className="relative">
        ...
        <div className="p-5 md:p-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              <div className="flex items-center">
                <h3 className="text-lg md:text-2xl font-bold tracking-tight text-blue-800 dark:text-blue-300">
                  Offre Élite Premium
                </h3>
                <Sparkles className="h-5 w-5 ml-2 text-blue-500" />
              </div>
              <p className="text-sm md:text-base text-blue-700 dark:text-blue-400 opacity-90">
                Notre offre la plus complète pour les professionnels
              </p>
            </div>
            
            <div className="flex items-center">
              <span className="text-2xl md:text-4xl font-bold text-blue-800 dark:text-blue-300">
                549€
              </span>
              <span className="text-sm md:text-base text-blue-700 dark:text-blue-400 ml-1">
                /an
              </span>
            </div>
          </div>
          ...
          <div className="mt-6 grid md:grid-cols-2 gap-4">
            <div>
              <h4 className="font-semibold text-sm md:text-base text-blue-700 dark:text-blue-400 mb-2">
                Fonctionnalités principales
              </h4>
              <ul className="space-y-2">
                <li className="flex items-center text-xs md:text-sm text-blue-800 dark:text-blue-300">
                ...
                <li className="flex items-center text-xs md:text-sm text-blue-800 dark:text-blue-300">
                  <Sparkles className="h-3.5 w-3.5 mr-2 text-blue-500" />
                  Commission de parrainage de 35%
                </li>
              </ul>
            </div>
          ...
          <div className="mt-6">
            <Button
              ...
              className={cn(
                ...
                isCurrentPlan ? "bg-green-500 text-white" : "bg-gradient-to-r from-blue-600 to-indigo-600 text-white"
              )}
