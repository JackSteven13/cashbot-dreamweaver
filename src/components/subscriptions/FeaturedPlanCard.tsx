    ...
    <div className="w-full flex flex-col">
      <div className={cn(
        ...
        isCurrentPlan 
          ...
          : "border-purple-500 bg-gradient-to-r from-purple-500/10 via-violet-500/10 to-purple-500/10"
      )}>
        <div className="relative">
          {/* Elite Badge */}
          <div className="absolute top-0 right-0 bg-gradient-to-r from-purple-600 to-violet-600 text-white px-4 py-1 rounded-bl-lg">
            ...
            <div className="mt-6 grid md:grid-cols-2 gap-4">
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-center text-xs md:text-sm text-purple-800 dark:text-purple-300">
                    ...
                    <strong>Commission de parrainage de 100%</strong>
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li className="flex items-center text-xs md:text-sm text-purple-800 dark:text-purple-300">
                    <PercentIcon className="h-3.5 w-3.5 mr-2 text-purple-500" />
                    <strong>30% de commission récurrente</strong>
                  </li>
                  <li className="flex items-center text-xs md:text-sm text-purple-800 dark:text-purple-300">
                    <Users className="h-3.5 w-3.5 mr-2 text-purple-500" />
                    <strong>10% de commission niveau 2</strong>
                  </li>
                  <li className="flex items-center text-xs md:text-sm text-purple-800 dark:text-purple-300">
                    <Sparkles className="h-3.5 w-3.5 mr-2 text-purple-500" />
            ...
            <div className="mt-6">
              <Button
                ...
                className={cn(
                  ...
                  isCurrentPlan ? "bg-green-500 text-white" : "bg-gradient-to-r from-purple-600 to-violet-600 text-white"
                )}
      ...
      <div className="mt-2 mx-auto flex items-center justify-center bg-amber-100 dark:bg-amber-900/30 text-amber-800 dark:text-amber-300 text-sm font-medium py-1.5 px-4 rounded-full border border-amber-200 dark:border-amber-800 shadow-sm">
        <PercentIcon className="h-4 w-4 mr-2" />
        <span>Commission de parrainage: <strong>100%</strong></span>
      </div>
    </div>
  );
};
