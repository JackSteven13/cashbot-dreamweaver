  ...
  return (
    <>
      ...
      <TermsSection title="10. Modifications d'Infrastructures et Stabilité du Service">
        ...
        <p className="ml-4"><strong>Stream Genius</strong> peut procéder à des opérations de maintenance planifiées, susceptibles d'entraîner une interruption temporaire des services. Ces opérations sont, dans la mesure du possible, programmées pendant les périodes de faible affluence et notifiées aux Utilisateurs au moins vingt-quatre heures à l'avance.</p>
      ...
      <TermsSection title="11. Dispositions Financières et Conservation des Fonds">
        ...
        <p className="ml-4"><strong>Stream Genius</strong> peut instaurer des périodes de restriction des retraits, n'excédant pas soixante jours par année civile, afin de procéder à des audits financiers, des mises à jour systémiques, ou pour se conformer à des obligations légales. Ces périodes sont annoncées avec un préavis minimum de sept jours.</p>
      </TermsSection>
    </>
  );
};
