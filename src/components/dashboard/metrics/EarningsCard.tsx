...
import { TrendingUp, Calendar, PieChart, ArrowUpRight, CircleCheckIcon } from 'lucide-react';
...
const EarningsCard = ({ 
  ...
  // Obtenir la date actuelle et le jour de la semaine
    ...
    <Card className="shadow-md border-slate-200 dark:border-slate-700">
      <CardHeader className="pb-2">
        ...
        <div className="text-xs text-slate-500 dark:text-slate-400 flex items-center gap-1 -mt-1">
          <CircleCheckIcon className="h-3 w-3 text-green-500" />
          <span>Jour actuel: {dayOfWeek} ({formattedDate})</span>
        </div>
      </CardHeader>
