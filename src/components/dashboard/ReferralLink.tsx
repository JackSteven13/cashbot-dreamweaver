      ...
      <div className="p-4 lg:p-6 space-y-4">
        ...
        <div className="bg-white rounded-lg p-4 shadow-sm border border-blue-100">
          <p className="text-sm text-[#486581] mb-3 font-medium">
            Partagez ce lien avec vos amis et gagnez <span className="font-bold text-green-600">70% de commission</span> sur leurs revenus !
          </p>
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1" className="border-none">
            ...
            <AccordionContent className="bg-blue-50 p-3 rounded-md border border-blue-100 text-xs text-blue-700">
              ...
              <p className="mt-2 font-medium text-blue-800">Les commissions sont attribuées automatiquement - aucune action supplémentaire requise!</p>
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </div>
