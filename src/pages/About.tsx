        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <p className="text-xl mb-8">
              Bienvenue sur Stream genius, la plateforme qui transforme le visionnage automatique de vidéos publicitaires sponsorisées en une source de revenus passifs. 
              Grâce à notre bot avancé, vous pouvez générer des gains confortables sans effort, où que vous soyez.
            </p>
            
            <h2 className="text-2xl font-semibold mt-12 mb-4">Comment ça fonctionne ?</h2>
            <p>
              Stream genius utilise une technologie intelligente qui travaille pour vous 24h/24. 
              Pendant que vous vaquez à vos occupations, notre bot parcourt le web et visionne des annonces sponsorisées, convertissant ce temps de visionnage en revenus réels.
            </p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mb-2">
                    ...
                    connectée à la plateforme augmente notre capacité de visionnage et démultiplie les revenus générés.
                  </p>
                  <p>
            ...
            <p>
              Plus il y a d'utilisateurs sur Stream genius, plus notre bot peut visionner de vidéos publicitaires sponsorisées. 
            ...
            <p>
              En plus de vos revenus générés automatiquement par notre bot visionnant des vidéos publicitaires, Stream genius vous permet de gagner encore plus grâce à notre programme de parrainage. 
            ...
            <ul className="space-y-4 my-6">
              <li className="flex items-start">
                ...
                <span><strong>100% automatique :</strong> Pas besoin d'intervenir, notre bot visionne les publicités pour vous.</span>
              </li>
              <li className="flex items-start">
                <Check className="text-primary mr-2 mt-1 flex-shrink-0" size={20} />
              ...
              <li className="flex items-start">
                <Check className="text-primary mr-2 mt-1 flex-shrink-0" size={20} />
                <span><strong>Technologie évolutive :</strong> Notre bot s'améliore avec chaque nouvel utilisateur.</span>
              </li>
              <li className="flex items-start">
                <Check className="text-primary mr-2 mt-1 flex-shrink-0" size={20} />
